...
import { createAccount } from '~/utils/queries.server'
...
console.log(actionData)
    ...
    return (
            ...
            <div style={{ background: 'radial-gradient(circle, #ff0000, #800000)' }}  className="h-[100vh]  justify-center items-center flex flex-col gap-y-4">
